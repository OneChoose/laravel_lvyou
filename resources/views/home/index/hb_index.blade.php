...
<div class="container">
    ...
    <section class="header-box">
        ...
        <div class="date-control">
            <form>
                <span>获享最优惠房价保证</span>
						<span class="input-group">
							<label>入住</label>
							<input class="laydate-icon"onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
						</span>
						<span class="input-group">
							<label>退房</label>
							<input class="laydate-icon" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
            ...
            <div class="nv-message">
                <span style="font-size: 14px;">旅行地信息</span>
        ...
        <div class="home-change">
            <a class="current" href="/?index=hb">仙女山华邦酒店</a>
            <a class="change" href="/?index=zy">仙女山拙雅酒店</a>
        </div>
    </section>
    <!--fast-track-->
    <section class="nav-track">
        ...
        <a href="/meeting/index?index={{ isset($_GET['index']) && !empty($_GET['index']) ? $_GET['index'] : 'hb' }}">
            <div>
                <h2>会议与宴会</h2>
                <span>休闲娱乐活动时光<i class="fa fa-angle-right"></i></span>
            </div>
        </a>
        <a href="/feiyi">
            <div>
    ...
    <section class="content">
        <div class="ct-dome">
            <div class="ct-img">
                <img src="/home/img/img-06.png" class="ct-img-hover">
        ...
        <div class="ct-dome mt10">
            <img src="/home/img/img-06-03.png" class="ct-img-hover" >
            <div class="ct-img-bg"></div>
                <div class="lv-message">
                    ...
                    <div class="lv-message-box">
                        ...
                        <a class="current" href="/entertainment/index?index={{ isset($_GET['index']) && !empty($_GET['index']) ? $_GET['index'] : 'hb' }}">查看详情</a>
                    </div>
                    </a>
                </div>
        ...
        <div class="ct-dome mt10">
            <img src="/home/img/img-07.png" class="ct-img-hover" >
            <div class="ct-img-bg"></div>
            <div class="lv-message p-r" >
                <a href="/travel">
                    <div class="lv-message-box">
                        ...
                        <a class="current" href="/travel">查看详情</a>
                    </div>
                </a>
            </div>
        </div>
