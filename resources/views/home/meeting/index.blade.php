...
<div class="container">
    ...
    <section class="content">
        <div class="paging-dome">
            <div class="room-mes">
                <div class="room-mes-box" style="width:100%;">
                    <h2>
                        <a>会议</a>|
                        <a>宴会</a>|
                        <a>金典会议</a>
                        ...
                        <li>
                            <div>
                                ...
                                <div class="pt-list-ms repast-list-ms room-list-ms">
                                    <h3>{{ $v->title }}</h3>
                                    <p><span>最多容纳：</span>    <span>{{ $v->price }}</span></p>
                                    <p><span>面积：</span>    <span>{{ $v->supply_time }}</span></p>
                                    <p class="room-price">
                                        <a href="/entertainment/order/{{ $v->id }}">详情</a>
                                    </p>
                                </div>
                            </div>
                        </li>
