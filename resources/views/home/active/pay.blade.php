        ...
        <div class="bgo-content ">
            <div class="col-xs-8 mt55 order-content ">
                <p style="font-size: 24px; padding-top: 20px;">
                    <span style="color: #191311;">活动：{{ $active->name  }}</span>
                    <span style="color: #aa0017; float: right;">¥{{ $active->price }}元</span>
                </p>
                <p>
                    订单详情<br>
                    <br>
                    商品名称：  {{ $active->name  }}<br>
                    <br>
                    交易金额： {{ $active->price }}元<br>
                    <br>
                    订单号：   {{ $order }}<br>
                </p>
                <div class="order-demo" style="padding: 20px;">
                    <form method="post" action="{{ url('active/pay') }}">
                        {{ csrf_field() }}
