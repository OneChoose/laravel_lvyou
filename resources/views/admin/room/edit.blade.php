    ...
    <div class="row">
        ...
        <div class="col-xs-10">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/room/update">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="title" data-rule="required;" value="{{ $room->title }}">
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <select class="form-control c" name="type" id="driver_area">
                                        ...
                                        <option value="华邦" {{ ($room->type == '华邦' ) ? "selected='selectet'": '' }}>华邦</option>
                                        <option value="拙雅" {{ ($room->type == '拙雅' ) ? "selected='selectet'": '' }}>拙雅</option>
                                    </select>
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="price" data-rule="required;" value="{{ $room->price }}">
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="person" data-rule="required;" value="{{ $room->persom }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="surplus_amount" data-rule="required;" value="{{ $room->surplus_amount }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="facility" data-rule="required;" value="{{ $room->facility }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="keywords" data-rule="required;" value="{{ $room->keywords }}">
                                </div>
                            </div>
                            <style type="text/css">
                                .btn {
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="description" data-rule="required;" value="{{ $room->description }}">
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <textarea id="container" name="content">{{ $room->content }}</textarea>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="sort" data-rule="required;" value="{{ $room->sort }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="click" data-rule="required;" value="{{ $room->click }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    通过
                                    <input type="radio" value="true" name="checkinfo" {{ $room->checkinfo == 'true' ? 'checked="checked"' : '' }}>
                                    未通过
                                    <input type="radio" value="false" name="checkinfo" {{ $room->checkinfo == 'false' ? 'checked="checked"' : '' }}>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" id="posttime"
                                           value="{{ $room->updated_at }}" name="posttime"
                                           data-rule="required;">
                                    <script type="text/javascript">
                                        date = new Date();
                                        Calendar.setup({
