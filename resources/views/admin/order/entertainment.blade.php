        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                <div id="side-wigVw4RU" class="list-group">
                    ...
                    <a href="/admin/order/index/2" class="list-group-item active"><i class="fa fa-list fa-fw"></i>娱乐订单</a>
            ...
            <div class="container-fluid" id="content_box_blank">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="row form-group">
                                <label class="col-xs-2 control-label">娱乐名称</label>

                                <div class="col-xs-6">
                                    {{ $info->getEntertainment->title }}
                                </div>
                            ...
                            <div class="row form-group">
                                <label class="col-xs-2 control-label">娱乐价格</label>

                                <div class="col-xs-6">
                                    {{ $info->getEntertainment->price }}
                                </div>
