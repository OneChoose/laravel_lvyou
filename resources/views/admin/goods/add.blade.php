    ...
    <div class="row">
        ...
        <div class="col-xs-10">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/goods/save">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="marketprice" data-rule="required;">
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="salesprice" data-rule="required;">
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="housenum" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="source" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="author" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    通过
                                    <input type="radio" value="ture" checked="checked" name="checked"
                                           data-rule="required;">
                                    未通过
                                    <input type="radio" value="false" name="checked" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
