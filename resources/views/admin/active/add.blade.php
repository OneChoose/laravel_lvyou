    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/active/add" class="list-group-item active"><i class="fa fa-list fa-fw"></i>添加促销活动</a>
                <a href="/admin/active/index" class="list-group-item"><i class="fa fa-list fa-fw"></i>促销活动列表</a>
            </div>
        </div>
        <div class="col-xs-10">
            <ol class="breadcrumb">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/active/save">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="name" data-rule="required;" value="">
                                </div>
