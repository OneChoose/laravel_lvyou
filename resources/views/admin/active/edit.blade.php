...
<div class="container-fluid" id="content_box">
    <div class="row">
        ...
        <div class="col-xs-10">
            <ol class="breadcrumb">
                <li>促销活动</li>
                <li class="active">修改促销活动</li>
            </ol>
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/active/update">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="name" data-rule="required;" value="{{ $active->name }}">
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="price" data-rule="required;" value="{{ $active->price }}">
                                </div>
                                <label class="col-xs-0 control-label errMsg">{{ $errors->first('price') }}</label>
                            </div>
                            <div class="row form-group">
                                <label class="col-xs-2 control-label">促销活动</label>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <textarea id="container" name="content">{{ $active->content }}</textarea>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" id="posttime"
                                           value="{{ $active->updated_at }}" name="posttime"
                                           data-rule="required;">
                                    <script type="text/javascript">
                                        date = new Date();
                                        Calendar.setup({
