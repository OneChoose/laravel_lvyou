    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/article/index" class="list-group-item active"><i class="fa fa-list fa-fw"></i>文章管理</a>
        ...
        <div class="col-xs-10">
            ...
            <a href="/admin/article/add" class="btn btn-primary" style="float: right"><i class="fa fa-plus fa-lg"></i>
                新增文章</a>
                ...
                @forelse($article as $v)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ url('admin/article/'.$v->id.'/edit') }}" class="edit"> 修改</a>
                        </td>
                    </tr>
                @empty
                    <p>没有类容</p>
