    ...
    <div class="row">
        ...
        <div class="col-xs-10">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/meeting/save" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="location" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="area" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="terms" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
