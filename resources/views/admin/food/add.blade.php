    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/food/add" class="list-group-item active"><i class="fa fa-list fa-fw"></i>添加餐饮</a>
        ...
        <div class="col-xs-10">
            <ol class="breadcrumb">
                <li>餐饮管理</li>
                <li class="active">添加餐饮</li>
            </ol>
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/food/save">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="supply_time" data-rule="required;">
                                </div>
                            </div>
                            <style type="text/css">
                                .btn {
