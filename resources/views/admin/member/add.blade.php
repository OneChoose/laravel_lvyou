    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/member/add" class="list-group-item active"><i class="fa fa-list fa-fw"></i>添加会员</a>
            </div>
        </div>
        <div class="col-xs-10">
            <ol class="breadcrumb">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/member/save" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="username" placeholder="{{ $errors->first('username')  }}" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-xs-2 control-label">密码</label>
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="password" placeholder="{{ $errors->first('password')  }}" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="mobile" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    男
                                    <input type="radio" name="sex" value="1" data-rule="required;">
                                    女
                                    <input type="radio" name="sex" value="0" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-xs-2 control-label">积分</label>
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="integral" data-rule="required;">
                                </div>
                            </div>
                        </div>
