    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            ...
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/addRole" class="list-group-item active"><i class="fa fa-list fa-fw"></i>新增角色</a>
            </div>
        </div>
        <div class="col-xs-10">
            <ol class="breadcrumb">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/saveRole">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
