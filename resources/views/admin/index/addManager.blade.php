    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/addManager" class="list-group-item active"><i class="fa fa-list fa-fw"></i>新增管理员</a>
            </div>
            <div id="side-wigVw4RU" class="list-group">
        ...
        <div class="col-xs-10">
            ...
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/saveManagers">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            <div class="row form-group">
                                ...
                                <label class="col-xs-0 control-label errMsg">{{ $errors->first('email') }}</label>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <label class="col-xs-0 control-label errMsg">{{ $errors->first('password') }}</label>
                            </div>
                        </div>
