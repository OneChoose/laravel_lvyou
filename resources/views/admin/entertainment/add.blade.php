    ...
    <div class="row">
        ...
        <div class="col-xs-2" id="nav_left">
            <div id="side-wigVw4RU" class="list-group">
                ...
                <a href="/admin/entertainment/add" class="list-group-item active"><i class="fa fa-list fa-fw"></i>添加休闲娱乐</a>
        ...
        <div class="col-xs-10">
            <ol class="breadcrumb">
                <li>休闲娱乐</li>
                <li class="active">添加休闲娱乐</li>
            </ol>
            <div class="container-fluid" id="content_box_blank">
                <form id="form_add" class="form-horizontal" method="post" action="/admin/entertainment/save">
                    <div class="row">
                        <div class="col-xs-12">
                            {{ csrf_field() }}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" name="introduction" data-rule="required;">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" id="opentime" value="" name="opentime" data-rule="required;">
                                    <script type="text/javascript">
                                        date = new Date();
                                        Calendar.setup({
                                            inputField: "opentime",
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" id="closetime" value="" name="closetime" data-rule="required;">
                                    <script type="text/javascript">
                                        date = new Date();
                                        Calendar.setup({
